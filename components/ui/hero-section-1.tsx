                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                src="https://images.unsplash.com/photo-1526406915894-6c1b7d5b54f4?q=80&w=1600&auto=format&fit=crop"
                                alt="background"
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=2400&auto=format&fit=crop"
                                        alt="app screen"
                                        width={2700}
                                        height={1440}
                                    />
                                    <img
                                        ...
                                        src="https://images.unsplash.com/photo-1515879218367-8466d910aaa4?q=80&w=2400&auto=format&fit=crop"
                                        alt="app screen"
                                        width={2700}
                                        height={1440}
                                    />
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            <div className="flex">
                                <img
                                    ...
                                    src="https://upload.wikimedia.org/wikipedia/commons/4/4f/Nvidia_logo.svg"
                                    alt="Nvidia Logo"
                                    height={20}
                                    width={80}
                                />
                            ...
                            <div className="flex">
                                <img
                                    ...
                                    src="https://upload.wikimedia.org/wikipedia/commons/9/91/Laravel.svg"
                                    alt="Laravel Logo"
                                    height={16}
                                    width={80}
                                />
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-4 w-fit dark:invert"
                                    src="https://upload.wikimedia.org/wikipedia/commons/9/95/GitHub_Logo.svg"
                                    alt="GitHub Logo"
                                    height={16}
                                    width={80}
                                />
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-5 w-fit dark:invert"
                                    src="https://upload.wikimedia.org/wikipedia/commons/3/35/Lemon_Squeezy_logo.svg"
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-4 w-fit dark:invert"
                                    src="https://upload.wikimedia.org/wikipedia/commons/a/ae/OpenAI_Logo.svg"
                                    alt="OpenAI Logo"
                                    height={16}
                                    width={80}
                                />
                            ...
                            <div className="flex">
                                <img
                                    ...
                                    src="https://upload.wikimedia.org/wikipedia/commons/3/39/Stripe_Logo%2C_revised_2016.svg"
                                    alt="Stripe Logo"
                                    height={28}
                                    width={80}
                                />
